...
import img2 from '../../images2/hot-tea.jpg'
import img3 from '../../images2/turmeric-powder.jpg'
import img4 from '../../images2/saffron-bg.jpg'
import img5 from '../../images2/ginger-tea.jpg'
            ...
            <div className="blogPost">
                ...
                <div className="Fblogmatter">
                    <div className="Blogmatter">
                        ...
                        {/* <div className="readmorebtn"><Button buttonStyle='btn--round-whitebor'>Read More > </Button></div> */}
                        <Link to="/Blog_read/Blog2"><button style={{border:"1px solid white", marginBottom:"5%"}} className="shopNowbtn" type="submit">Read More ></button></Link>
                    </div>
                </div>
            </div>
            <div className="tags"><h2>TAGS:</h2><a className="first-link" href="/"><u>nourishing food</u></a>
            <a className="first-link" href="/"><u>nutritional value</u></a>
            <a className="first-link" href="/"><u>antioxidants</u></a>
            </div>
            ...
            <div className="blogPost">
                ...
                <div className="Fblogmatter">
                    <div className="Blogmatter">
                        ...
                        {/* <div className="readmorebtn"><Button buttonStyle='btn--round-whitebor'>Read More > </Button></div> */}
                        <Link to="/Blog_read/Blog3"><button style={{border:"1px solid white", marginBottom:"5%"}} className="shopNowbtn" type="submit">Read More ></button></Link>
                    </div>
                </div>
            </div>
            <div className="tags"><h2>TAGS:</h2><a className="first-link" href="/"><u>Lakadong Turmeric</u></a>
            <a className="first-link" href="/"><u>Lakadong Turmeric as immunity booster</u></a>
            <a className="first-link" href="/"><u>Health benefits of Lakadong Turmeric</u></a>
            </div>
            ...
            <div className="blogPost">
                ...
                <div className="Fblogmatter">
                    <div className="Blogmatter">
                        ...
                        {/* <div className="readmorebtn"><Button buttonStyle='btn--round-whitebor'>Read More > </Button></div> */}
                        <Link to="/Blog_read/Blog4"><button style={{border:"1px solid white", marginBottom:"5%"}} className="shopNowbtn" type="submit">Read More ></button></Link>
                    </div>
                </div>
            </div>
            <div className="tags"><h2>TAGS:</h2><a className="first-link" href="/"><u>Health benefits of Kashmiri Saffron</u></a>
            <a className="first-link" href="/"><u>high-altitude regions of the Himalayas.</u></a>
            <a className="first-link" href="/"><u>Kashmiri kitchen</u></a>
            </div>
            ...
            <div className="blogPost">
                ...
                <div className="Fblogmatter">
                    <div className="Blogmatter">
                        ...
                        {/* <div className="readmorebtn"><Button buttonStyle='btn--round-whitebor'>Read More > </Button></div> */}
                        <Link to="/Blog_read/Blog5"><button style={{border:"1px solid white", marginBottom:"5%"}} className="shopNowbtn" type="submit">Read More ></button></Link>
                    </div>
                </div>
            </div>
            <div className="tags"><h2>TAGS:</h2><a className="first-link" href="/"><u>use of steam to sterilize</u></a>
            <a className="first-link" href="/"><u>no adultration</u></a>
            <a className="first-link" href="/"><u>natural goodness of products</u></a>
            </div>
