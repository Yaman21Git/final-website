        ...
        <>
          ...
          <div className="content">
              ...
              <h1 className="otherhead">Organic farming benefits:</h1>
                ...
                <span class="shopnow_dot1" style={{marginLeft:"10%",textAlign:"right"}}><Link to="/Blog_read/Blog5" style={{textDecoration:"none",color:"black"}}><p>←</p></Link></span>
                ...
                <span class="shopnow_dot1"><Link to="/Blog_read/Blog2" style={{textDecoration:"none",color:"black"}}><p>→</p></Link></span>
          </div>
