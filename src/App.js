...
import Blog2 from './components/Pages/Blog_read/Blog2'
import Blog3 from './components/Pages/Blog_read/Blog3'
import Blog4 from './components/Pages/Blog_read/Blog4'
import Blog5 from './components/Pages/Blog_read/Blog5'
        ...
        <>
         <Router>
           ...
           <Switch>
             ...
             <Route exact path='/Blog_read/Blog2' component={Blog2}/>
             <Route exact path='/Blog_read/Blog3' component={Blog3}/>
             <Route exact path='/Blog_read/Blog4' component={Blog4}/>
             <Route exact path='/Blog_read/Blog5' component={Blog5}/>
